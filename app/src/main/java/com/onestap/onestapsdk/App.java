...
import com.onestap.onestap.user.model.domain.entities.Address;
import com.onestap.onestap.user.model.domain.entities.Document;
import com.onestap.onestap.user.model.domain.entities.Email;
import com.onestap.onestap.user.model.domain.entities.PersonalData;
import com.onestap.onestap.user.model.domain.entities.Phone;
import com.onestap.onestap.user.model.domain.entities.TempProfile;
import com.onestap.onestap.user.model.domain.entities.Vehicle;
